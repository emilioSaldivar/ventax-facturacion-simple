...
| Red compartida con facturacion-electronica — migrar de fe-{prod,test}_default a ventax_fiscal_{prod,test} con alias facturacion-electronica, estandar declarado por el proveedor (precedente pos-graciela: 50s -> 476ms) | [SPEC_RED_COMPARTIDA_FISCAL_v0.1.md](SPEC_RED_COMPARTIDA_FISCAL_v0.1.md) | SPEC + PLAN + TASKS listos — secuenciado despues del deploy del fix de verificacion fiscal | 2026-08-29 |
