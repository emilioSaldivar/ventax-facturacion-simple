...
| Alineacion de clave en verificacion fiscal — el worker F9 manda la clave de consumidor a `/documentos/:uuid/sifen`, que exige la clave compartida (401) — INCIDENTE ACTIVO EN PRODUCCION | [SPEC_ALINEACION_CLAVE_VERIFICACION_FISCAL_v0.1.md](SPEC_ALINEACION_CLAVE_VERIFICACION_FISCAL_v0.1.md) | SPEC + PLAN + TASKS listos — pendiente IMPLEMENT | 2026-08-28 |
