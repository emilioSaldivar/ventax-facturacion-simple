...
- `docs/TASKS_DOCUMENTOS_EMISION_UX_v0.1.md`
- `docs/SPEC_IDENTIDAD_OPERATIVA_FACTURADOR_v0.1.md`
- `docs/PLAN_IDENTIDAD_OPERATIVA_FACTURADOR_v0.1.md`
- `docs/TASKS_IDENTIDAD_OPERATIVA_FACTURADOR_v0.1.md`
- `docs/SPEC_IMPORT_CONFIG_FACTURADOR_v0.1.md`
- `docs/PLAN_IMPORT_CONFIG_FACTURADOR_v0.1.md`
- `docs/SPEC_SEGMENTACION_PERFIL_EMISION_v0.1.md`
- `docs/PLAN_SEGMENTACION_PERFIL_EMISION_v0.1.md`
- `docs/TASKS_IMPORT_CONFIG_FACTURADOR_v0.1.md`
- `docs/TASKS_SEGMENTACION_PERFIL_EMISION_v0.1.md`
- `docs/SPEC_IMPORT_CONFIG_FACTURADOR_v0.2.md`
- `docs/PLAN_IMPORT_CONFIG_FACTURADOR_v0.2.md`
